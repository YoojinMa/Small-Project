...
public class UsedItemService {
	...
	// 기존 물건 가격 수정
	public static boolean updateUsedItemPrice(String usedItemId, String usedItemPrice) throws SQLException, NotExistException {
		notExistUsedItem(usedItemId);
		return UsedItemDAO.updateUsedItemPrice(usedItemId, usedItemPrice);
	}
	
	// 기존 물건 거래 상태 수정
		public static boolean updateDealStatus(String usedItemId, String dealStatus) throws SQLException, NotExistException {
			notExistUsedItem(usedItemId);
	...
	public static boolean updateUsedItemUserSeller(int usedItemUserId, String sellerId) throws SQLException, NotExistException {
		notExistUsedItemUser(usedItemUserId);
		return UsedItemUploadDAO.updateUsedItemUploadSeller(usedItemUserId, sellerId);
	}
	
	public static boolean updateUsedItemUserBuyer(int usedItemUserId, String  buyerId) throws SQLException, NotExistException {
		notExistUsedItemUser(usedItemUserId);
